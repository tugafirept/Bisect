...
const pt: Strings = {
  ...
  help: {
    ...
    bullets: [
      ...
      "pp = pontos percentuais: 8 pp acima de 50 significa uma metade com 58%.",
...
const en: Strings = {
  ...
  help: {
    ...
    bullets: [
      ...
      "pp = percentage points: 8 pp over 50 means one half is 58%.",
...
const es: Strings = {
  ...
  help: {
    ...
    bullets: [
      ...
      "pp = puntos porcentuales: 8 pp por encima de 50 significa una mitad al 58%.",
...
const fr: Strings = {
  ...
  help: {
    ...
    bullets: [
      ...
      "pp = points de pourcentage : 8 pp au-dessus de 50, c'est une moitié à 58 %.",
...
const de: Strings = {
  ...
  help: {
    ...
    bullets: [
      ...
      "pp = Prozentpunkte: 8 pp über 50 heißt, eine Hälfte hat 58 %.",
